...
const bonusProductDef =
  require('../../common/models/Model.BonusProduct.json');
...
module.exports = function(dataSource) {
  ...
  // "Bonus Product"
  const BonusProduct = dataSource.createModel(
    bonusProductDef.name,
    bonusProductDef.properties,
    getSettings(bonusProductDef)
  );
